              ...
              <Card className="card-user">
                <CardBody>
                  ...
                  <div className="card-description">
                        <h3>Hoofd vraag:</h3>
                        <h5>Op welke manier kunnen Natural User Interfaces het gebruik van applicaties bevorderen?</h5>
                        ...
                        <li className="list-unstyled">
                            <ul>
                              <li>Op welke manieren word de NUI momenteel gebruikt?</li>
                            </ul>
                        </li>
                        <li>Toekomst</li>
                        <li className="list-unstyled">
